...
const styles = StyleSheet.create({
  container: {
    // Bu kapsayıcı, dropdown'ın üst bileşeninde konumlandırılması için kullanılır.
    // Dropdown menüsü, bunun içinde mutlak konumlandırılmıştır.
    // Düzen için burada belirli stillere gerek yoktur, üst bileşende yerleştirilecektir.
  },
  mealDropdown: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  dropdownMenu: {
    position: 'absolute',
    top: '110%', // Butonun altına konumlandır
    right: 0,
    borderRadius: 12,
    borderWidth: 1,
    borderColor: COLORS.border,
    width: 220,
    zIndex: 999, // Z-index değeri artırıldı
    overflow: 'hidden',
    elevation: 5,
    shadowColor: '#000',
