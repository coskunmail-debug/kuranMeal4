    ...
    <>
      <Stack>
        ...
        <Stack.Screen
          name="surah/[id]"
          options={({ route }) => {
            const { id, selectedMeal } = route.params as { id: string; selectedMeal: string };
            const surah = SURAHS.find((s) => s.id === Number(id));
            const mealAccentColor = MEAL_COLORS[selectedMeal] || COLORS.primary;
            const displayMealName = MEAL_DISPLAY_NAMES[selectedMeal] || selectedMeal;
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flexShrink: 1 }}>
                  ...
                  <Text
                    ...
                    style={{
                      ...
                      color: mealAccentColor,
                      flexShrink: 1,
                    }}
                  >
                    {displayMealName} Meali:
                  </Text>
                </View>
              ),
            };
